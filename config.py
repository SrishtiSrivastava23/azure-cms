...
class Config(object):
    ...
    # SQLAlchemy connection string (cleaned)
    ...
    AUTHORITY = os.environ.get('AUTHORITY') or "https://login.microsoftonline.com/common"  # multi-tenant
    REDIRECT_PATH = "/getAToken"
    SCOPE = ["User.Read"]  # Only read user profile
    SESSION_TYPE = "filesystem"  # Server-side session for token cache
